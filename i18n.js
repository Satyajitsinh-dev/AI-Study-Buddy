...
const TRANSLATIONS = {
  en: {
    ...
    reg_success_title:    'Check Your Email!',
    reg_success_sub:      'We\'ve sent a magic link to your admin email. Click it to activate your account and complete school setup.',
    reg_success_url_label:'Your School\'s App URL',
    reg_copy_url:         '📋 Copy URL',
    reg_copied:           '✅ Copied!',
    reg_next_steps:       'What happens next:',
    reg_step1:            'Click the magic link in your email to activate your admin account',
    reg_step2:            'You\'ll land back on the app — complete the required school setup',
    reg_step3:            'Upload your question bank from the 📂 Question Bank section',
    reg_step4:            'Your school URL will be shown once setup is complete — then share it',
    reg_url_after_setup:  '🔒 Your school URL will appear after you complete admin setup.',
    reg_open_app_pending: 'Waiting for setup…',
  ...
  hi: {
    ...
    reg_success_title:    'ईमेल चेक करें!',
    reg_success_sub:      'आपके admin ईमेल पर एक magic link भेजा गया है। अपना account activate करने और school setup पूरा करने के लिए उस पर क्लिक करें।',
    reg_success_url_label:'आपके स्कूल का App URL',
    reg_copy_url:         '📋 URL Copy करें',
    reg_copied:           '✅ Copy हो गया!',
    reg_next_steps:       'आगे क्या होगा:',
    reg_step1:            'अपने ईमेल में magic link पर क्लिक करके admin account activate करें',
    reg_step2:            'App पर वापस आएंगे — जरूरी school setup पूरा करें',
    reg_step3:            '📂 Question Bank section से question bank upload करें',
    reg_step4:            'Setup पूरा होने के बाद आपका school URL दिखेगा — फिर teachers और students को share करें',
    reg_url_after_setup:  '🔒 Admin setup पूरा होने के बाद school URL दिखेगा।',
    reg_open_app_pending: 'Setup का इंतज़ार है…',
  ...
  gu: {
    ...
    reg_success_title:    'ઈ-મેઈલ ચેક કરો!',
    reg_success_sub:      'તમારા admin ઈ-મેઈલ પર magic link મોકલવામાં આવ્યો છે. Account activate કરવા અને school setup પૂર્ણ કરવા ક્લિક કરો.',
    reg_success_url_label:'તમારી શાળાનો App URL',
    reg_copy_url:         '📋 URL Copy કરો',
    reg_copied:           '✅ Copy થઈ ગયું!',
    reg_next_steps:       'આગળ શું થશે:',
    reg_step1:            'ઈ-મેઈલમાં magic link ક્લિક કરી admin account activate કરો',
    reg_step2:            'App પર પાછા આવશો — જરૂરી school setup પૂર્ણ કરો',
    reg_step3:            '📂 Question Bank section માંથી question bank upload કરો',
    reg_step4:            'Setup પૂર્ણ થયા પછી school URL દેખાશે — પછી teachers અને students ને share કરો',
    reg_url_after_setup:  '🔒 Admin setup પૂર્ણ થયા પછી school URL દેખાશે.',
    reg_open_app_pending: 'Setup ની રાહ છે…',
